...
public class JFrameView implements ActionListener{
	...
	JButton bplus, bminus, bdiv, bmul;
    ...
    public JFrameView() {
        ...
        f.setResizable(true);
        t.setBounds(40,30,280,40);
        b1.setBounds(50,100, 50,20);
        b2.setBounds(150,100, 50, 20);
        b3.setBounds(250,100, 50, 20);
        bplus.setBounds(350,100, 50, 20);
        b4.setBounds(50,130, 50,20);
        b5.setBounds(150,130, 50, 20);
        b6.setBounds(250,130, 50, 20);
        bminus.setBounds(350,130, 50, 20);
        b7.setBounds(50,160, 50,20);
        b8.setBounds(150,160, 50, 20);
        b9.setBounds(250,160, 50, 20);
        bdiv.setBounds(350,160, 50, 20);
        b0.setBounds(150,190, 50, 20);
        bmul.setBounds(350,190, 50, 20);
        bclear.setBounds(70,250,100,40);
        bresult.setBounds(190,250,100,40);
        f.add(b1);
        f.add(b2);
        f.add(b3);
        f.add(b4);
